...
import shepherdsithole.com.powlet.activities.MainActivity;
import shepherdsithole.com.powlet.activities.PuchasisHistory;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public static void sendNotification( Context context ,String title , String messageBody ,String  eventid) {
        Intent intent = new Intent(context, PuchasisHistory.class);
        ...
        notificationManager.notify(122 /* ID of notification */, notificationBuilder.build());
    }
}